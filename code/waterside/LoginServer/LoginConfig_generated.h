...
#ifndef FLATBUFFERS_GENERATED_LOGINCONFIG_WATERSIDE_H_
#define FLATBUFFERS_GENERATED_LOGINCONFIG_WATERSIDE_H_
...
struct LoginConfig;
struct LoginConfigBuilder;

/// 登录服务器配置
struct LoginConfig FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef LoginConfigBuilder Builder;
  ...
  /// 登录数据库配置
  const waterside::MysqlConfig *login_db() const {
    return GetPointer<const waterside::MysqlConfig *>(VT_LOGIN_DB);
  }
  /// 网络监听配置
  ...
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyOffsetRequired(verifier, VT_LOGIN_DB) &&
           verifier.VerifyTable(login_db()) &&
...
struct LoginConfigBuilder {
  typedef LoginConfig Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_server_id(int32_t server_id) {
    fbb_.AddElement<int32_t>(LoginConfig::VT_SERVER_ID, server_id, 0);
  }
  void add_service_name(::flatbuffers::Offset<::flatbuffers::String> service_name) {
    fbb_.AddOffset(LoginConfig::VT_SERVICE_NAME, service_name);
  }
  void add_logic_fps(float logic_fps) {
    fbb_.AddElement<float>(LoginConfig::VT_LOGIC_FPS, logic_fps, 0.0f);
  }
  void add_logic_fps_warning(float logic_fps_warning) {
    fbb_.AddElement<float>(LoginConfig::VT_LOGIC_FPS_WARNING, logic_fps_warning, 0.0f);
  }
  void add_login_db(::flatbuffers::Offset<waterside::MysqlConfig> login_db) {
    fbb_.AddOffset(LoginConfig::VT_LOGIN_DB, login_db);
  }
  void add_network(::flatbuffers::Offset<waterside::NetworkListenConfig> network) {
    fbb_.AddOffset(LoginConfig::VT_NETWORK, network);
  }
  void add_namereg_ip(::flatbuffers::Offset<::flatbuffers::String> namereg_ip) {
    fbb_.AddOffset(LoginConfig::VT_NAMEREG_IP, namereg_ip);
  }
  void add_namereg_port(::flatbuffers::Offset<::flatbuffers::String> namereg_port) {
    fbb_.AddOffset(LoginConfig::VT_NAMEREG_PORT, namereg_port);
  }
  explicit LoginConfigBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<LoginConfig> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<LoginConfig>(end);
    fbb_.Required(o, LoginConfig::VT_SERVICE_NAME);
    fbb_.Required(o, LoginConfig::VT_LOGIN_DB);
    fbb_.Required(o, LoginConfig::VT_NETWORK);
    fbb_.Required(o, LoginConfig::VT_NAMEREG_IP);
    fbb_.Required(o, LoginConfig::VT_NAMEREG_PORT);
    return o;
  }
};

inline ::flatbuffers::Offset<LoginConfig> CreateLoginConfig(
    ::flatbuffers::FlatBufferBuilder &_fbb,
    int32_t server_id = 0,
    ::flatbuffers::Offset<::flatbuffers::String> service_name = 0,
    float logic_fps = 0.0f,
    float logic_fps_warning = 0.0f,
    ::flatbuffers::Offset<waterside::MysqlConfig> login_db = 0,
...
inline ::flatbuffers::Offset<LoginConfig> CreateLoginConfigDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
    int32_t server_id = 0,
  ...
  return waterside::CreateLoginConfig(
      _fbb,
      server_id,
      service_name__,
      logic_fps,
...
inline const waterside::LoginConfig *GetLoginConfig(const void *buf) {
  return ::flatbuffers::GetRoot<waterside::LoginConfig>(buf);
}

inline const waterside::LoginConfig *GetSizePrefixedLoginConfig(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<waterside::LoginConfig>(buf);
}

inline bool VerifyLoginConfigBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<waterside::LoginConfig>(nullptr);
}

inline bool VerifySizePrefixedLoginConfigBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<waterside::LoginConfig>(nullptr);
}

inline void FinishLoginConfigBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<waterside::LoginConfig> root) {
  fbb.Finish(root);
}

inline void FinishSizePrefixedLoginConfigBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<waterside::LoginConfig> root) {
...
#endif  // FLATBUFFERS_GENERATED_LOGINCONFIG_WATERSIDE_H_
