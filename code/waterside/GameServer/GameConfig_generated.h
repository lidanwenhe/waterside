...
#ifndef FLATBUFFERS_GENERATED_GAMECONFIG_WATERSIDE_H_
#define FLATBUFFERS_GENERATED_GAMECONFIG_WATERSIDE_H_
...
struct GameConfig FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef GameConfigBuilder Builder;
...
struct GameConfigBuilder {
  typedef GameConfig Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_server_id(int32_t server_id) {
    fbb_.AddElement<int32_t>(GameConfig::VT_SERVER_ID, server_id, 0);
  }
  void add_service_name(::flatbuffers::Offset<::flatbuffers::String> service_name) {
    fbb_.AddOffset(GameConfig::VT_SERVICE_NAME, service_name);
  }
  void add_logic_fps(float logic_fps) {
    fbb_.AddElement<float>(GameConfig::VT_LOGIC_FPS, logic_fps, 0.0f);
  }
  void add_logic_fps_warning(float logic_fps_warning) {
    fbb_.AddElement<float>(GameConfig::VT_LOGIC_FPS_WARNING, logic_fps_warning, 0.0f);
  }
  void add_network(::flatbuffers::Offset<waterside::NetworkListenConfig> network) {
    fbb_.AddOffset(GameConfig::VT_NETWORK, network);
  }
  void add_namereg_ip(::flatbuffers::Offset<::flatbuffers::String> namereg_ip) {
    fbb_.AddOffset(GameConfig::VT_NAMEREG_IP, namereg_ip);
  }
  void add_namereg_port(::flatbuffers::Offset<::flatbuffers::String> namereg_port) {
    fbb_.AddOffset(GameConfig::VT_NAMEREG_PORT, namereg_port);
  }
  explicit GameConfigBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<GameConfig> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<GameConfig>(end);
    fbb_.Required(o, GameConfig::VT_SERVICE_NAME);
    fbb_.Required(o, GameConfig::VT_NETWORK);
    fbb_.Required(o, GameConfig::VT_NAMEREG_IP);
    fbb_.Required(o, GameConfig::VT_NAMEREG_PORT);
    return o;
  }
};

inline ::flatbuffers::Offset<GameConfig> CreateGameConfig(
...
inline ::flatbuffers::Offset<GameConfig> CreateGameConfigDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
    int32_t server_id = 0,
  ...
  return waterside::CreateGameConfig(
      _fbb,
      server_id,
      service_name__,
      logic_fps,
...
inline const waterside::GameConfig *GetGameConfig(const void *buf) {
  return ::flatbuffers::GetRoot<waterside::GameConfig>(buf);
}

inline const waterside::GameConfig *GetSizePrefixedGameConfig(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<waterside::GameConfig>(buf);
}

inline bool VerifyGameConfigBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<waterside::GameConfig>(nullptr);
}

inline bool VerifySizePrefixedGameConfigBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<waterside::GameConfig>(nullptr);
}

inline void FinishGameConfigBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<waterside::GameConfig> root) {
  fbb.Finish(root);
}

inline void FinishSizePrefixedGameConfigBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<waterside::GameConfig> root) {
...
#endif  // FLATBUFFERS_GENERATED_GAMECONFIG_WATERSIDE_H_
